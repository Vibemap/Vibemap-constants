...
var activityCategories = [
	{
		...
		details: {
			...
			sub_categories: [
				...
				{
					name: "Visit",
					description: "Visitors guide to the best of %city%. Discover culture, history, and landmarks while having a fun, memorable time sightseeing and exploring. We've collected must see spots and favorite for tourist and locals alike. Plan your trip or weekend getaway and book these attractions for free or at a discount. ",
					parent: 0,
					slug: "visit",
					id: 6298
				},
				{
					name: "Drink",
					description: "Where to drink and enjoy beer, wine, cocktails and sober-friendly options including coffee, tea, and more. Discover drinking styles like tiki, bubbly, and sober-friendly. Beyond watering holes, check out outdoor spots, events, and tours. ",
					parent: 6295,
					slug: "drinking",
					id: 6328
				},
				...
				{
					name: "Community",
					description: "Explore ways to get involved in your local community. Support local businesses, volunteer, give back, or pay it forward with these community groups and hubs of local culture. ",
					parent: 6295,
					slug: "community",
					id: 6293
				},
