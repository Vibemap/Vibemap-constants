...
var activityCategories = [
	{
		...
		details: {
			...
			sub_categories: [
				...
				{
					name: "Visit",
					description: "Visitors guide to the best of %city%. Discover culture, history, and landmarks while having a fun, memorable time exploring.",
					parent: 0,
					slug: "visit",
					id: 6298
				},
				{
					name: "Drink",
					description: "Where to drink and enjoy beer, wine, cocktails and sober-friendly options including coffee, tea, and more. Beyond watering holes, check out outdoor spots, events, and tours.",
					parent: 6295,
					slug: "drinking",
					id: 6328
				},
